...
slides.push({ no:"06", title:"Connected players: who plugs in directly?", time:"2:00", type:"Concept",
  ...
  boxes:[
    { kind:"screen", lines:[
      ...
      "**GDS**  ·  Amadeus  ·  Galileo  ·  Sabre  ·  Travelport",
    ...
    { kind:"narration", lines:[
      ...
      { t:"*Then GDS, which is Amadeus, Galileo, Sabre and Travelport. And our own direct channels, dusit.com with its booking engine, and central reservations when a guest picks up the phone.*", italics:true },
...
slides.push({ no:"12", title:"GDS and metasearch", time:"1:30", type:"Concept",
  ...
  boxes:[
    { kind:"screen", lines:[
      "**GDS**",
      "The booking network corporate travel bookers and traditional agents work inside. Amadeus, Galileo, Sabre, Travelport.",
