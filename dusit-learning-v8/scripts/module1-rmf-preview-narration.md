...
## Slide 8. Section transition — closing five questions, opening rate architecture

### Reading text (~28 sec spoken)

> Let's take stock.
>
> [pause 0.4s]
>
> You've named all five. Guest, time, channel, price, room.
>
> [pause 0.3s]
>
> Every rate at Dusit is built from those five.
>
> [pause 0.8s]
>
> But rates don't sit still.
>
> [pause 0.3s]
>
> When Revenue moves BAR, every derived rate moves with it — Corporate, Gold, Advance Saver, Stay Longer, all of them, automatically.
>
> [pause 0.5s]
>
> That's rate architecture.
>
> [pause 0.3s]
>
> It's what section two is about.

### Cue map

| # | Action | Target           | Spoken line |
|---|--------|------------------|-------------|
| 0 | reveal | close-eye        | Let's take stock. |
| 1 | reveal | close-1          | You've named all five. Guest, time, channel, price, room. |
| 2 | reveal | close-2          | Every rate at Dusit is built from those five. |
| 3 | reveal | bridge-1         | But rates don't sit still. |
| 4 | reveal | bridge-2         | When Revenue moves BAR, every derived rate moves with it — Corporate, Gold, Advance Saver, Stay Longer, all of them, automatically. |
| 5 | reveal | section-2-eye    | That's rate architecture. |
| 6 | reveal | section-2-title  | It's what section two is about. |

**Notes for the actor:** This is a chapter-break slide. Deliver the closer half (cues 0–2) with a settling cadence — the sound of *"we've arrived at somewhere"*. Then the pivot (cues 4–5) lifts fresh — small energy change on *"But rates don't sit still"*. Cue 6 says the term with quiet weight. Cue 7 lands as an invitation.

---

## Slide 9. Conditions on top of BAR (Rate architecture, Dusit-narrow sense)
...
## Slide 10. The System (BAR propagation)
...
## Slide 12. Checklist (before the quiz)
